...
export _DISABLESERVICES="avahi-daemon colord cups-browsed cups epmd iscsid ModemManager monit nfs-blkmap nfs-idmapd nfs-mountd triggerhappy unattended-upgrades winbind wpa_supplicant"
