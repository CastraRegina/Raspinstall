...
export _SW2INSTALL="$_SW2INSTALL printer-driver-hpcups hplip printer-driver-cups-pdf antiword docx2txt"
...
export _SW2INSTALL="$_SW2INSTALL swaks monit openprinting-ppds foomatic-db-gutenprint gimp xpaint libjpeg-progs ufraw"
